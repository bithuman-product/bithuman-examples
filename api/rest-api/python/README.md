...
pip install -r requirements.txt
cp .env.example .env
# Edit .env -- add your API secret from https://www.bithuman.ai/developer/api-keys (Developer → API Secrets)
```
...
|----------|----------|-------------|
| `BITHUMAN_API_SECRET` | Yes | Your API secret from https://www.bithuman.ai/developer/api-keys (Developer → API Secrets) |
